...
func TestTrackWriteEffects_StagedDeltas(t *testing.T) {
	...
	// Simulate an UPDATE inside a transaction.
...
func TestTrackWriteEffects_StagedTombstones(t *testing.T) {
	...
	// Simulate a DELETE inside a transaction.
	cl := &core.Classification{
		OpType:  core.OpWrite,
	...
	// Staged tombstone is visible during txn.
...
func TestTrackWriteEffects_OutsideTxn(t *testing.T) {
	...
	// No TxnHandler — outside transaction.
	cl := &core.Classification{
		OpType:  core.OpWrite,
		SubType: core.SubUpdate,
		Tables:  []string{"users"},
...
func TestExtHandler_Accumulate_Parse(t *testing.T) {
	...
	// Build a Parse message: stmtName\0 + sql\0 + int16(0 params)
...
func TestParseParseMsgPayload(t *testing.T) {
	// Build payload: stmtName\0 + sql\0
...
func TestParseCloseMsgPayload(t *testing.T) {
	// Build payload: type_byte('S') + name\0
