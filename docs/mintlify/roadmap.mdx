...
<CardGroup cols={2}>
  <Card title="PostgreSQL Core">
    Full CRUD, merged reads (single table + JOINs), transactions, DDL, schema adaptation. 202+ E2E tests.
  </Card>
  <Card title="9 Engines">
    PostgreSQL, CockroachDB, MySQL, MariaDB, MS SQL Server, Oracle, SQLite, Redis, Firestore.
  </Card>
  ...
  <Card title="Developer Tools">
    TUI dashboard, MCP server for AI agents, structured logging, full CLI.
  </Card>
</CardGroup>
